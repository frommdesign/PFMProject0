...
//==============================================================================
const juce::String PFM0AudioProcessor::getName() const
{
...
const juce::String PFM0AudioProcessor::getProgramName (int index)
{
    return {};
}

void PFM0AudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void PFM0AudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* PFM0AudioProcessor::createEditor()
{
    return new PFM0AudioProcessorEditor (*this);
}

//==============================================================================
void PFM0AudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
